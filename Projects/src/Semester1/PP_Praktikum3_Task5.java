...
public class PP_Praktikum3_Task5 {
    public static void main(String[] args) {
        ...
        while (weitereSuche) {
            ...
            // Suchvorgang aufrufen
            searchAndDisplayResult(words, searchWord);
    ...
    // Methode für den Suchvorgang
    private static void searchAndDisplayResult(String[] array, String key) {
        int position = binarySearch(array, key);

        if (position >= 0) {
            System.out.println("Das Wort \"" + key + "\" wurde an Position " + position + " gefunden.");
        } else {
            System.out.println("Das Wort \"" + key + "\" wurde nicht gefunden.");
        }
    }
